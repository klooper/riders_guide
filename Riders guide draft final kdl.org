...
[[~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Documents/Org/img/HCE.svg]]
...
#+NAME: *Figure 1:*
#+ATTR_HTML: :width 360px
[[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Screenshots/Screenshot 2025-12-24 103041.png]]
...
You can schedule trips yourself using the HCE Rides app without having to call Hamilton County Express reservations. Rides must be scheduled at least two hours prior to pickup. Follow these steps:
     *1. Open the HCE Rides App.*
       The home screen opens with your current location, as shown in Figure 2.
        ...
        #+NAME: *Figure 2:
        #+ATTR_HTML: :width 360px
	[[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Screenshots/rgfig01.png.png]]
    ...
    *2. Type your /destination/ into the Where To search box.*
       ...
       #+NAME: Figure 3:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig03.png]]
       ...
       #+NAME: Figure 4:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig04.png]]
    ...
    *3. If the default pickup location is correct, then click the Set As Pickup button.*
       ...
       #+NAME: Figure 5:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig05.png]]
    ...
    *4. Click and review the four buttons above the Select Hamilton County Express button.*
       ...
       #+NAME: Figure 6:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig06.png]]

       #+CAPTION: The eWallet option shows your balance before you book a trip. 
       #+NAME: Figure 7:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig07.png]]
    ...
    *5. After you confirm the four buttons, click Select Hamilton County Express Service.*
	...
	The Confirm Trip Details screen appears, as shown in Figure 8.
       ...
       #+NAME: Figure 8:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig08.png]]
    ...
    *6. Click the Schedule Ride button.*
	...
	You will see a confirmation of your ride, as shown in Figure 9.
       ...
       #+NAME: Figure 9:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig09.png]]
...
To move the pin, click the Set on map option, and then drag the map as shown in Figure 10.
       ...
       #+NAME: Figure 10:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig10.png]]
...
#+begin_tip
      Sometimes the best way to communicate with the driver is by adding a pickup note, where you can give information such as a particular door or entry code, as shown below.
       ...
       #+NAME:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfigtip01.png]]
#+end_tip
...
You can add a favorite location any time you choose a destination. Just tap the heart symbol by the location, as shown in Figure 11.
       ...
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig11.png]]
 ...
 If you want to delete a favorite location, follow these steps:
    1. Tap on the profile circle at the top left of the Where To screen to open your profile, as shown in Figure 12.
       ...
       #+NAME: Figure 12:
       #+ATTR_HTML: :width 180px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig13.png]]
    ...
    5. Tap the Delete Favorite Location button, as shown in Figure 14.
       ...
       #+NAME: Figure 14:
       #+ATTR_HTML: :width 360px
       [[file:~/OneDrive - JANUS DEVELOPMENTAL SERVICES, INC/Pictures/Riders guide/rgfig14.png]]
