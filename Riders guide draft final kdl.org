...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/readtheorg/css/htmlize.css"/>
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/readtheorg/css/readtheorg.css"/>
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/readtheorg/css/code-copy.css"/>
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/readtheorg/css/search.css"/>
#+HTML_HEAD: <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
#+HTML_HEAD: <script src="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/js/bootstrap.min.js"></script>
#+HTML_HEAD: <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/vendor/stickytableheaders/jquery.stickytableheaders.min.js"></script>
#+HTML_HEAD: <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/readtheorg/js/search.js"></script>
#+HTML_HEAD: <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/readtheorg/js/readtheorg.js"></script>
#+HTML_HEAD: <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/fniessen/org-html-themes/src/readtheorg/js/code-copy.js"></script>
...
- *Marion County* - IndyGo +1 (317) 635-3344 ([[https://indygo.net/routes][IndyGo web site]]). HCE provides service connections to and from the following IndyGo bus stops in Indianapolis:
...
- *Madison Co.* - Transportation for Rural Areas of Madison Co. (TRAM) ([[https://www.cirta.us/county-connect/transportation-resources/tram/][TRAM web site]]). +1 (885) 743-3843. HCE provides service connections to and from the following (TRAM) connecting location in Pendleton:
  + *Loves Travel Stop* 9000 Interpark Dr., Pendleton, IN 46064
...
You can schedule trips yourself using the HCE Rides app without having to call Hamilton County Express reservations. Rides must be scheduled at least two hours prior to pickup. Follow these steps:
    ...
    *4. Click and review the four buttons above the Select Hamilton County Express button.*
        They are:
          ...
          + *Accessibility options:* Clicking on the top-right button allows you to ensure that all accessibility needs for the ride are accounted for. Click Confirm Accessibility to confirm your selections. Check out [[Changing Accessibility Options in the HCE Rides App][Changing Accessibility Options in the HCE Rides App]] for more information.
         ...
         + *Payment Method:* Clicking the bottom-right button allows you to choose between the cash and eWallet options. The balance on your eWallet is shown next to the Wallet (Reloadable) option, as shown in Figure 7. Click Confirm Payment Method to continue. *Note that your eWallet will be charged when you complete the reservation.* See [[Paying for Trips on HCE][Paying for Trips on HCE]] for more information.
    ...
    *6. Click the Schedule Ride button.*
	...
	You will see a confirmation of your ride, as shown in Figure 9.
       ...
       #+CAPTION: If you don't see ride with [driver name] (left), then your ride is in unmatched status, meaning that you don't yet have the ride, but we're working on it.
       #+NAME: Figure 9:
...
Things come up. Things change. We understand this. From time to time, it may be necessary to cancel your trip. Please cancel your trip as soon as possible to provide space for other riders. It’s much better to cancel your existing trip than to have the bus come to pick you up and not board it. Not boarding a trip that has come to pick you up is classified as a No-Show, and it can affect your access to future rides.
...
Remember: Regardless of how you cancel your trip, it’s important to provide a reason for the cancellation. Cancellations reasons that are accepted can help to maintain your access to future HCE rides. See our [[Policy: Late Cancellations and No-Shows][Late Cancellation and No-Show Policy]].
...
On Android, go to Settings > Notifications > Advanced Settings > Notification History. Toggle the Use Notification History setting to on. This allows you to view the notification history, as shown in Figure 14.
  ...
  #+NAME: Figure 14:
  #+ATTR_HTML: :width 360px
  [[https://raw.githubusercontent.com/klooper/riders_guide/main/img/rgfig14.png]]
...
- Reasonable Accommodations: The following are accommodations that HCE can make for passengers with special needs:
...
To set up particular needs for a particular ride, follow these steps:
  1. Set up your ride as described in [[Scheduling Trips Using the HCE Rides App][Scheduling Trips Using the HCE Rides App]].
...
To apply for a subscription trip, fill out this [[https://docs.google.com/forms/d/e/1FAIpQLSdDRpElzaYAbluEVRgGbxNY8t3oK94Z-GJPo9FaMmoQxOsqAg/viewform?usp=sharing&ouid=104367918995370115081][online subscription request form]].
